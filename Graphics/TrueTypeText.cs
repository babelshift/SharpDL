...
namespace SharpDL.Graphics
{
    public class TrueTypeText : ITrueTypeText
    {
        ...
        public void UpdateText(string text, FontSurfaceType fontSurfaceType)
        {
            UpdateText(text, 0, fontSurfaceType);
        }

        public void UpdateText(string text, int wrapLength, FontSurfaceType fontSurfaceType)
        {
            if (Texture == null)
            {
            ...
            ISurface surface = new Surface(Font, text, Color, wrapLength, fontSurfaceType);
